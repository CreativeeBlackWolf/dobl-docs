...
!!! note "Количество очков для распределения Очков Здоровья и Очков Маны ограничено 250. На каждую единицу ОЗ тратится 1.5 очков распределения, на ОМ - 1 очко"
...
- улучшить случайный параметр выбранного предмета на 60% (1 ОД)
    + или получить случайное свойство с шансом `1/(кол-во свойств + 1)`
- улучшить выбранный параметр предмета на 60% (3 ОД)
- улучшить случайный параметр выбранного навыка на 30% (1 ОД)
    + или получить случайное свойство из другого навыка с шансом `1/(кол-во свойств + 1)`
- улучшить выбранный параметр навыка на 30% (3 ОД)
- увеличить макс. ОЗ или ОМ на 15% (1 ОД)
